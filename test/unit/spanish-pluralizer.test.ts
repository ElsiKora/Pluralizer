...
describe('SpanishPluralizer', () => {
  ...
  describe('pluralize', () => {
    ...
    it('should respect gender when pluralizing', () => {
      ...
      const wordTests = [
        { singular: 'gato', gender: Gender.Masculine, plural: 'gatos' },
        { singular: 'gata', gender: Gender.Feminine, plural: 'gatas' },
        { singular: 'abogado', gender: Gender.Masculine, plural: 'abogados' },
        { singular: 'abogada', gender: Gender.Feminine, plural: 'abogadas' },
        { singular: 'niño', gender: Gender.Masculine, plural: 'niños' },
        { singular: 'niña', gender: Gender.Feminine, plural: 'niñas' },
        { singular: 'señor', gender: Gender.Masculine, plural: 'señores' },
        { singular: 'señora', gender: Gender.Feminine, plural: 'señoras' },
      ];

...
// Список существительных, которые неправильно определяются как множественное число
const englishFalsePluralWords = [
    'analysis', 'thesis', 'basis', 'crisis', 'bus', 'box', 'cactus', 'focus', 'fungus', 'syllabus', 'nucleus'
];
const englishIrregularPlurals = {
    // Специальные случаи для заведомо проблемных слов
    'bus': 'buses',
    'box': 'boxes',
    'thesis': 'theses',
    'analysis': 'analyses',
...
const englishIrregularSingulars = Object.entries(englishIrregularPlurals)
    .reduce((acc, [singular, plural]) => {
    acc[plural] = singular;
    return acc;
}, {});
// Words that are the same in singular and plural forms
const englishUncountableWords = [
    // Abstract concepts
    'equipment',
    'information',
    'knowledge',
...
exports.englishFalsePluralWords = englishFalsePluralWords;
exports.englishIrregularPlurals = englishIrregularPlurals;
exports.englishIrregularSingulars = englishIrregularSingulars;
exports.englishUncountableWords = englishUncountableWords;

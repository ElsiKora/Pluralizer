...
import { 
  russianIrregularPlurals, 
  russianIrregularSingulars,
  russianUncountableWords 
} from '../../infrastructure/exceptions/russian-exceptions.service';
import { 
  russianPluralRules, 
  russianSingularRules 
} from '../../infrastructure/rules/russian-rules.service';

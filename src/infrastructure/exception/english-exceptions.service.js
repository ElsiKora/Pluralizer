...
export const englishIrregularSingulars = Object.entries(englishIrregularPlurals)
    .reduce((acc, [singular, plural]) => {
    acc[plural] = singular;
    return acc;
}, {});
// Words that are the same in singular and plural forms
export const englishUncountableWords = [
    // Abstract concepts
    'equipment',
    'information',
    'knowledge',

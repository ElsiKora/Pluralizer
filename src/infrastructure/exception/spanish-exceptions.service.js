...
export const spanishFalsePluralWords = [
    'crisis', 'análisis', 'tesis', 'lunes', 'martes', 'miércoles', 'jueves', 'viernes', 'virus', 'atlas'
];
export const spanishIrregularPlurals = {
...
export const spanishIrregularSingulars = Object.entries(spanishIrregularPlurals)
...
export const spanishUncountableWords = [
    // Days of the week 
    'lunes',
    'martes',
    'miércoles',
...
export const spanishGenderChanges = {

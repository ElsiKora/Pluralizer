...
import {
  spanishFalsePluralWords,
  spanishIrregularPlurals, spanishIrregularSingulars, spanishUncountableWords
} from "../../infrastructure/exception/spanish-exceptions.service";
